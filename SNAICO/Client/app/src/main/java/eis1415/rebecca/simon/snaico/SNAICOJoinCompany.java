...
public class SNAICOJoinCompany extends Activity {
    ...
    private class joinCompany extends AsyncTask<String, Void, Boolean> {
        ...
        protected void onPreExecute() {
            this.dialog.setMessage("Firma wird beigetreten");
            this.dialog.show();
        }

        protected void onPostExecute(final Boolean success) {
            if (dialog.isShowing()) {
                if(httpResponseStr.equals("success")){
                    this.dialog.setMessage("Erfolgreich beigetreten.");
                    dialog.dismiss();
                    Intent mainIntent = new Intent(SNAICOJoinCompany.this, SNAICOOverviewStaff.class);
